...
/* pb00b_adc0_ain12 */
#define PB00B_ADC0_AIN12 \
	SAM_PINMUX(b, 0, b, periph)

/* pb00b_ptc_xy30 */
#define PB00B_PTC_XY30 \
	SAM_PINMUX(b, 0, b, periph)
...
/* pb01b_adc0_ain13 */
#define PB01B_ADC0_AIN13 \
	SAM_PINMUX(b, 1, b, periph)

/* pb01b_ptc_xy31 */
#define PB01B_PTC_XY31 \
	SAM_PINMUX(b, 1, b, periph)
...
/* pb06b_ptc_xy24 */
#define PB06B_PTC_XY24 \
	SAM_PINMUX(b, 6, b, periph)

/* pb06n_ccl_in6 */
#define PB06N_CCL_IN6 \
...
/* pb07b_ptc_xy25 */
#define PB07B_PTC_XY25 \
	SAM_PINMUX(b, 7, b, periph)

/* pb07n_ccl_in7 */
#define PB07N_CCL_IN7 \
...
/* pc00a_eic_extint0 */
#define PC00A_EIC_EXTINT0 \
	SAM_PINMUX(c, 0, a, periph)

/* pc00b_adc1_ain10 */
#define PC00B_ADC1_AIN10 \
...
/* pc01a_eic_extint1 */
#define PC01A_EIC_EXTINT1 \
	SAM_PINMUX(c, 1, a, periph)

/* pc01b_adc1_ain11 */
#define PC01B_ADC1_AIN11 \
...
/* pc02a_eic_extint2 */
#define PC02A_EIC_EXTINT2 \
	SAM_PINMUX(c, 2, a, periph)

/* pc02b_adc1_ain4 */
#define PC02B_ADC1_AIN4 \
...
/* pc03a_eic_extint3 */
#define PC03A_EIC_EXTINT3 \
	SAM_PINMUX(c, 3, a, periph)

/* pc03b_adc1_ain5 */
#define PC03B_ADC1_AIN5 \
...
/* pc04a_eic_extint4 */
#define PC04A_EIC_EXTINT4 \
	SAM_PINMUX(c, 4, a, periph)

/* pc04c_sercom6_pad0 */
#define PC04C_SERCOM6_PAD0 \
	SAM_PINMUX(c, 4, c, periph)

/* pc04f_tcc0_wo0 */
#define PC04F_TCC0_WO0 \
...
/* pc05a_eic_extint5 */
#define PC05A_EIC_EXTINT5 \
	SAM_PINMUX(c, 5, a, periph)

/* pc05c_sercom6_pad1 */
#define PC05C_SERCOM6_PAD1 \
...
/* pc06a_eic_extint6 */
#define PC06A_EIC_EXTINT6 \
	SAM_PINMUX(c, 6, a, periph)

/* pc06c_sercom6_pad2 */
#define PC06C_SERCOM6_PAD2 \
	SAM_PINMUX(c, 6, c, periph)

/* pc06i_sdhc0_cd */
#define PC06I_SDHC0_CD \
...
/* pc07a_eic_extint7 */
#define PC07A_EIC_EXTINT7 \
	SAM_PINMUX(c, 7, a, periph)

/* pc07c_sercom6_pad3 */
#define PC07C_SERCOM6_PAD3 \
	SAM_PINMUX(c, 7, c, periph)

/* pc07i_sdhc0_wp */
#define PC07I_SDHC0_WP \
...
/* pd00a_eic_extint0 */
#define PD00A_EIC_EXTINT0 \
	SAM_PINMUX(d, 0, a, periph)

/* pd00b_adc1_ain14 */
#define PD00B_ADC1_AIN14 \
...
/* pd01a_eic_extint1 */
#define PD01A_EIC_EXTINT1 \
	SAM_PINMUX(d, 1, a, periph)

/* pd01b_adc1_ain15 */
#define PD01B_ADC1_AIN15 \
...
/* pd08a_eic_extint3 */
#define PD08A_EIC_EXTINT3 \
	SAM_PINMUX(d, 8, a, periph)

/* pd08c_sercom7_pad0 */
#define PD08C_SERCOM7_PAD0 \
	SAM_PINMUX(d, 8, c, periph)

/* pd08d_sercom6_pad1 */
#define PD08D_SERCOM6_PAD1 \
	SAM_PINMUX(d, 8, d, periph)

/* pd08f_tcc0_wo1 */
#define PD08F_TCC0_WO1 \
...
/* pd09a_eic_extint4 */
#define PD09A_EIC_EXTINT4 \
	SAM_PINMUX(d, 9, a, periph)

/* pd09c_sercom7_pad1 */
#define PD09C_SERCOM7_PAD1 \
	SAM_PINMUX(d, 9, c, periph)

/* pd09d_sercom6_pad0 */
#define PD09D_SERCOM6_PAD0 \
	SAM_PINMUX(d, 9, d, periph)

/* pd09f_tcc0_wo2 */
#define PD09F_TCC0_WO2 \
